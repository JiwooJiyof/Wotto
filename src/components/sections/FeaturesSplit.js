          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              ...
              >
                ...
                <h3 className="mt-0 mb-12">Have Chance at Big Rewards</h3>
                <p className="m-0">
                  Scratch your Wotto scratch tickets for a chance at big
                  rewards, and keep saving to unlock more. The money you save
                  will continue to produce tokens month to month.
                </p>
              </div>
              <div
                className={classNames(
